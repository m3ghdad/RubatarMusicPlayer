            ...
            VStack(spacing: 0) {
                ...
                */
                ...
                MenuItemView(
                    id: "deepanalysis",
                    icon: "book.pages",
                    title: selectedLanguage.deepAnalysisTitle,
    ...
    var body: some View {
        HStack(spacing: 8) {
            ...
            Image(systemName: icon)
                .font(.system(size: 17))
                .foregroundColor(isSelected ? (colorScheme == .dark ? Color.yellow : Color(hex: "D78F0C")) : (colorScheme == .dark ? .white : Color(hex: "333333")))
